...
class HarDNet(nn.Module):
    def __init__(self, n_classes=19):
        ...
        # Improvements:
        # 1) Increase number of scale stages from 6 to 7 or 8 (8x8 or 4x4 min featuremap size respectively)
        ...
        # HarDNet-large
        # first_ch = [32, 48, 48, 48]
        # ch_list = [64, 96, 160, 224, 320, 448]
        # grmul = 1.7
        # gr = [10, 12, 14, 16, 20, 22]
        # n_layers = [4, 4, 8, 8, 8, 8]

        # first_ch = [32, 40, 48, 64]
        # ch_list = [96, 160, 224, 320, 480, 720]
        # grmul = 1.7
        # gr = [24,  24,  28,  36,  48, 64]
        # n_layers = [4, 8, 8, 8, 8, 8, 8]

        first_ch = [48, 50, 56, 64]
        ch_list = [64, 96, 160, 224, 320, 480]
        grmul = 1.7
        gr = [10, 12, 14, 16, 20, 22]
        n_layers = [4, 4, 8, 8, 8, 8]
